...
def test_dbusobject_method_call(dbus_service):
    """
...
def test_dbusobject_wrong_method_call(dbus_service):
    """
...
def test_dbusobject_get_property(dbus_service):
    """
...
def test_dbusobject_get_all_properties(dbus_service):
    """
...
def test_dbusobject_wrong_property(dbus_service):
    """
